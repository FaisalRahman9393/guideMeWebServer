...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <hr>
            <p>Please select a shop from the drop down menu</p>

            <center>
                <form name="chosenShop" method="post" action="Shops">
                    <input type="hidden" name="pagename" value="chosenShop"/>
                    Department Name:
                    <select style="color: #0b0b0b" name="selectedShop">
                    ...
                    <br><button class="btn btn-primary btn-xl page-scroll" type="submit">Get information</button><br />
                </form>
