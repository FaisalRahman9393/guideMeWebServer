...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <hr>
            <p>You can use the form below to add or edit shops</p>

            <center>
                <form name="shopsFormEditPressed" method="post" action="Shops">
                    <input type="hidden" name="pagename" value="shopsFormEditPressed"/>
                    <button class="btn btn-primary btn-xl page-scroll" type="submit">Edit current shops</button><br />
                </form>
                <br>
                <form action="adminShopsAddNew.jsp">
                    <input class="btn btn-primary btn-xl page-scroll" type="submit" value="Add new shops" />
                </form>
