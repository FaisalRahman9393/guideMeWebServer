...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <hr>
            <p>Please select a department from the drop down menu</p>

            <center>
                <form name="chosenDepartment" method="post" action="Departments">
                    <input style="color: #0b0b0b" type="hidden" name="pagename" value="chosenDepartment"/>
                    Department Name:
                    <select style="color: #0b0b0b" name="selectedDepart">
