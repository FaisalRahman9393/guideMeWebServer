        ...
        <div class="header-content-inner">
            ...
            <center>
                <form name="departmentsFormEditPressed" method="post" action="Departments">
                    ...
                    <button class="btn btn-primary btn-xl page-scroll" type="submit">Edit current departments</button><br />
                </form>
                <br>
                <form action="adminDepartmentsAddNew.jsp">
                    <input class="btn btn-primary btn-xl page-scroll" type="submit" value="Add a new department" />
                </form>
                <br>
