...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <hr>
            <p>You can use the form below to add or edit facilities</p>
            ...
            <center>
                <form name="facilitiesFormEditPressed" method="post" action="Facilities">
                    ...
                    <button class="btn btn-primary btn-xl page-scroll"  type="submit">Edit current facilities</button><br />
                </form>
                <br>
                <form action="adminFacilitiesAddNew.jsp">
                    <input class="btn btn-primary btn-xl page-scroll"  type="submit" value="Add new Facilities" />
                </form>
