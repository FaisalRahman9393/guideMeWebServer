...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <hr>
            <p>You can use the form below to add new facilities</p>

            <center>
                <form name="facilitiesFormAddNew" method="post" action="Facilities">
                    <input style="color: #0b0b0b" type="hidden" name="pagename" value="facilitiesFormAddNew"/>
                    Facility name:          <input style="color: #0b0b0b" size="35" type = "text" name = "facilityName" value= ""/><br />
                    <font color="red">Please note: Make sure that location is a valid google maps address.</font><br>
                    Facility location:          <input style="color: #0b0b0b" size="35" type = "text" name = "facilityLocation" value= ""/><br />
                    Facility Opening hours:    <input style="color: #0b0b0b" size="35" type = "text" name = "facilityOpeningHours" value= ""/><br />
                    Facility information:  <textarea style="color: #0b0b0b" rows="4" cols="50" name = "facilityInfo"></textarea><br />
