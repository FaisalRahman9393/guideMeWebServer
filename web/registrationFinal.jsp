...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h1 id="homeHeading"> Registration process</h1>
            <hr>
            <h2>You have now been sent a 6 digit code to your email address</h2>
            <h3>Enter it below with your preferred password: </h3>
            ...
            <center>
                <form name="regreg" method="post" action="RegMe">
                    ...
                    <table>
                        <tr>
                            Secret Pin: <input style="color: #0b0b0b" name="secPin" required="required" type="text" id="secPin" /><br>

                            Password:  <input style="color: #0b0b0b" name="password" required="required" type="password" id="password" /><br>
                            Confirm Password: <input style="color: #0b0b0b" name="password_confirm" required="required" type="password" id="password_confirm" oninput="check(this)" />
                            ...
                            <br /><br />
                            <input class="btn btn-primary btn-xl page-scroll" type="submit" />
                        </tr>
                    </table>
                </form>
