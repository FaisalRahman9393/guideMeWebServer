...
<header>
    <div class="header-content">
        ...
        <div class="header-content-inner">
            <h1 id="homeHeading"> <%=nameOfAcademic%>'s profile</h1>

            Welcome to Guide Me <%=nameOfAcademic%>.
            <hr>
            <p>You can use the form below to update your information</p>

            <center>
                <form name="profileForm" method="post" action="Profile">
                    <input type="hidden" name="pagename" value="profileForm"/>
                    Your name:          <input style="color: #0b0b0b" size="35" type = "text" name = "academicName" value= "<%=nameOfAcademic%>"/><br />
                    Your Role:          <input style="color: #0b0b0b" size="35" type = "text" name = "academicRole" value= "<%=roleOfAcademic%>"/><br />
                    Your Department:    <input style="color: #0b0b0b" size="35" type = "text" name = "academicDepartment" value= "<%=departmentOfAcademic%>"/><br />
                    Your Email Address: <input style="color: #0b0b0b" size="35" type = "text" name = "academicEmail" value= "<%=emailOfAcademic%>"/><br/>
                    Your Office:        <input style="color: #0b0b0b" size="35" type = "text" name = "academicOffice" value= "<%=officeOfAcademic%>"/><br />
                    Your Number:        <input style="color: #0b0b0b" size="35" type = "text" name = "academicNumber" value= "<%=numberOfAcademic%>"/><br />
                    Your Availability:  <textarea style="color: #0b0b0b" rows="4" cols="50" name = "academicAvailability"> <%=availabilityOfAcademic%></textarea><br />
