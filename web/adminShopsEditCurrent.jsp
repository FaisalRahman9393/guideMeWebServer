...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            ...
            <hr>
            <p>Please use the form below to update information about the selected shop</p>

            <center>
                <% String nameOfShop=(String)request.getAttribute("nameOfShop"); %>
                <% String locationOfShop=(String)request.getAttribute("shopLocation"); %>
                <% String openingHoursOfShop=(String)request.getAttribute("shopOpeningHours"); %>
                <% String infoShop=(String)request.getAttribute("shopInfo"); %>
                ...
                <form name="shopFormEditUpdate" method="post" action="Shops">
                    ...
                    Shop Name:          <input style="color: #0b0b0b" size="35" type = "text" name = "shopName" value= "<%=nameOfShop%>"/><br />
                    Shop Location:          <input style="color: #0b0b0b" size="35" type = "text" name = "shopLocation" value= "<%=locationOfShop%>"/><br />
                    Shop Opening Hours:    <input style="color: #0b0b0b" size="35" type = "text" name = "shopOpeningHours" value= "<%=openingHoursOfShop%>"/><br />
                    Shop Information: <input  style="color: #0b0b0b" size="35" type = "text" name = "shopInfo" value= "<%=infoShop%>"/><br/>
